  ...
  const renderTableBody = () => {
    ...
    if (schedule.length === 0)
      return (
        <tr>
          <td colSpan="10" className="p-8 text-center text-gray-500">
            ไม่พบข้อมูลตารางสอนในเทอม {selectedTerm}
          </td>
        </tr>
      );
              ...
              {classes.map((item, idx) => {
                ...
                return (
                  <div
                    ...
                    flex flex-col justify-center items-center text-center rounded-sm overflow-hidden p-1 transition-all hover:z-50"
                    style={{
                      left: `${leftPercent}%`,
                      width: `${widthPercent}%`,
                  ...
                  >
                    <div className="flex flex-col justify-center h-full w-full">
                      <u className="font-bold text-xs sm:text-sm">
                        {item.subject_id}
                      </u>
