...
// นำเข้าไฟล์ที่แยกไว้ (ตามที่คุณต้องการ)
          ...
          <div className="bg-white mt-4 p-4 rounded-[20px] shadow-sm border border-[#e9e9e9]">
            ...
            <div className="flex justify-between items-center mb-4 flex-wrap gap-2">
              <div className="flex items-center gap-3 flex-wrap">
                ...
                {/* 🟢 Dropdown สาขา (แบบเดิม - disabled เมื่อไม่เลือกคณะ) */}
                <select
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full border border-gray-200">
                <thead className="bg-[#f2f2f2]">
                  <tr>
                    <th className="text-left px-4 py-2 border border-gray-300">รหัสประจำตัว</th>
                    <th className="text-left px-4 py-2 border border-gray-300">ชื่อ - นามสกุล</th>
                    <th className="text-left px-4 py-2 border border-gray-300">คณะ</th>
                    <th className="text-left px-4 py-2 border border-gray-300">สาขา</th>
                    <th className="text-center px-4 py-2 border border-gray-300 w-[120px]">จัดการ</th>
                  </tr>
                </thead>
                <tbody>
                  {currentTeachers.length === 0 ? (
                    ...
                    currentTeachers.map((t) => (
                      <tr key={t.id} onClick={() => handleClick(t)} className="hover:bg-gray-100 cursor-pointer transition-colors duration-150 group">
                        <td className="px-4 py-2 border border-gray-300">{t.teacherId}</td>
                        <td className="px-4 py-2 border border-gray-300">{t.fullname}</td>
                        <td className="px-4 py-2 border border-gray-300">{t.faculty}</td>
                        <td className="px-4 py-2 border border-gray-300">{t.major}</td>
            ...
            <div className="flex justify-center mt-4 pb-2">
              <Pagination
                ...
                // 🟢 ข้อความ Pagination กลับเป็นแบบเดิม
