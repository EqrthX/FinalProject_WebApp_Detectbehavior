...
const CustomDropdown = ({
  ...
  return (
    ...
    >
      ...
      {isOpen && (
        <div
          className="absolute z-50 w-full mt-2 bg-white border border-gray-200 rounded-[20px] shadow-lg 
          ...
          {searchable && (
            <div className="p-2 border-b border-gray-100">
              <input
                type="text"
                placeholder="ค้นหา..."
                className="w-full px-3 py-1.5 text-sm bg-gray-50 border border-gray-200 rounded-md focus:outline-none 
                focus:ring-1 focus:ring-[#38A738]"
                value={searchTerm}
...
const AdminTeachers = () => {
  ...
  const majorOptions = filterMajorsToShow.map((m) => ({
    label: m.major_name,
    value: m.major_id,
  }));
    ...
    <div className="h-screen bg-[#f6f6f4] flex flex-col md:flex-row gap-1 p-4 overflow-hidden">
      ...
      <main className="flex-1 flex flex-col min-w-0 overflow-hidden lg:pl-[0rem]">
        <div className="max-w-screen-2xl mx-auto px-6 md:px-4 w-full h-full flex flex-col pb-4">
          ...
          <div
            className="w-full bg-white rounded-[15px] border border-[#e9e9e9] shadow-sm h-20 md:h-16 px-6 
          flex items-center justify-between mt-0 flex-shrink-0 sticky top-0 z-20"
          >
              ...
              <table className="min-w-full border-separate border-spacing-0 text-sm">
                <thead className="bg-[#f2f2f2] sticky top-0 z-[30] text-gray-700 font-semibold">
                  <tr>
                    ...
                    {/* คอลัมน์ทั่วไป */}
                    <th className="text-center px-4 py-3 border-b border-r border-gray-300 min-w-[200px]">
                      คณะ
                    </th>
                    <th className="text-center px-4 py-3 border-b border-r border-gray-300 min-w-[200px]">
                      สาขา
