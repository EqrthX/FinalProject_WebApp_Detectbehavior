            ...
            <div className="flex justify-between items-center mb-4 flex-wrap gap-2 shrink-0 border-b border-gray-100 pb-4">
              <div className="flex items-center gap-3 flex-wrap w-full xl:w-auto">
                ...
                <div className="relative w-full md:w-64">
                  ...
                  />
                  <label
                    className={`absolute left-4 bg-[#f9fafb] px-1 transition-all pointer-events-none rounded-sm z-10
                        ${
              ...
              <div className="flex gap-2 mt-2 xl:mt-0">
                <button
                  ...
                  className="bg-[#38A738] hover:bg-[#2d7c2d] text-white px-4 py-2 rounded-lg text-sm font-medium whitespace-nowrap"
                >
                  เพิ่มรายวิชา
                </button>
                <button
              ...
              <table className="min-w-full border-separate border-spacing-0 text-sm">
                <thead className="bg-[#f2f2f2] sticky top-0 z-[30] text-gray-700 font-semibold">
                  <tr>
                    ...
                    <th className="text-center px-4 py-3 border-b border-r border-gray-300 min-w-[40px]">
                      ปี
                    </th>
                    <th className="text-center px-4 py-3 border-b border-r border-gray-300 min-w-[40px]">
                      เทอม
                    ...
                    <th className="text-center px-4 py-3 border-b border-r border-gray-300 min-w-[80px]">
                      วัน
                    </th>
                    <th className="text-center px-4 py-3 border-b border-r border-gray-300 min-w-[120px] whitespace-nowrap">
                      เวลา
                    </th>
                    <th className="text-center px-4 py-3 border-b border-r border-gray-300 min-w-[100px]">
                      ห้อง
                    </th>
                    <th className="text-center px-4 py-3 border-b border-r border-gray-300 min-w-[60px]">
                      ตึก
                    </th>
                    <th className="text-center px-4 py-3 border-b border-r border-gray-300 min-w-[80px]">
                      หน่วยกิต
                    </th>
                    <th className="text-center px-4 py-3 border-b border-r border-gray-300 min-w-[200px] whitespace-nowrap">
                      ผู้สอน
                    </th>
                  ...
                  {isLoading ? (
                    ...
                    currentSchedules.map((t) => (
                      ...
                      >
                        ...
                        <td className="px-4 py-3 border-b border-r border-gray-300 text-center">
                          {t.year}
                        </td>
                        <td className="px-4 py-3 border-b border-r border-gray-300 text-center">
                          {t.semester}
                        ...
                        <td className="px-4 py-3 border-b border-r border-gray-300 text-center font-semibold text-gray-700">
                          {t.time}
                        </td>
                        <td className="px-4 py-3 border-b border-r border-gray-300 text-center font-semibold text-gray-700">
                          {t.room}
